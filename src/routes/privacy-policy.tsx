        ...
        <div className="mt-10 space-y-8 text-sd-gray-text leading-relaxed">
          ...
          <section>
            ...
            <p>
              ...
              our content and to improve performance. These include Google Analytics and Google Tag
              Manager, Meta (Facebook) Pixel, Metricool, and our customer-relationship platform
              GoHighLevel / ClickOne, which records site-navigation activity and may associate it
              with your contact record once you submit a form or otherwise identify yourself, so we
