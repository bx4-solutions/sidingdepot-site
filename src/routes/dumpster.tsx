...
const FAQS: ReadonlyArray<FaqItem> = [
  {
    ...
    a: "Dumpster rental in the North Atlanta area typically costs $350–$650 for a 10–20 yard dumpster for a standard 7-day rental. Price depends on dumpster size, rental period, and disposal fees. We serve Marietta, Canton, Woodstock, Kennesaw, and surrounding cities with same-day or next-day delivery available.",
  },
  {
  ...
  {
    q: "Do I need a permit for a dumpster in Marietta or Canton?",
