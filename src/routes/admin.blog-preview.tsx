    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-top-2 duration-300">
      ...
      <div className="bg-white rounded-xl border p-6 shadow-sm">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h4 className="font-bold text-sd-navy text-sm uppercase tracking-wider">Google Search Result</h4>
        </div>
        <div className="max-w-[600px] font-sans">
          <div className="flex items-center gap-1 text-[14px] text-[#202124] mb-1">
            <span className="bg-[#f1f3f4] rounded-full w-7 h-7 flex items-center justify-center text-[10px] font-bold">SD</span>
            <div className="flex flex-col">
              <span className="text-xs">Siding Depot</span>
              <span className="text-[12px] text-[#202124]/70">https://sidingdepot.com › blog › {post.slug}</span>
            </div>
          </div>
      ...
      <div className="bg-white rounded-xl border p-6 shadow-sm">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h4 className="font-bold text-sd-navy text-sm uppercase tracking-wider">Social Share (Facebook/LinkedIn)</h4>
        </div>
        <div className="max-w-[500px] border rounded-xl overflow-hidden bg-[#F2F3F5]">
          ...
          <div className="p-3 bg-white">
            <div className="text-[12px] text-gray-500 uppercase font-medium mb-0.5 tracking-tight">sidingdepot.com</div>
            <div className="text-[16px] font-bold text-[#1d2129] leading-tight mb-1">{post.metaTitle}</div>
            <div className="text-[14px] text-[#606770] line-clamp-2 leading-relaxed">{post.metaDescription}</div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-gray-50 rounded-xl border p-4">
        <h4 className="text-xs font-bold text-sd-navy/50 uppercase tracking-widest mb-3">Technical SEO Metadata</h4>
