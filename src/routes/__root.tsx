...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Georgia's trusted James Hardie Elite Preferred contractor. Siding, painting, windows, decks, gutters, roofing in Marietta e Região & North Atlanta." },
      ...
      { property: "og:title", content: "Siding Depot — James Hardie Elite Preferred Contractor in Marietta e Região GA" },
      { property: "og:description", content: "Georgia's trusted James Hardie Elite Preferred contractor. Siding, painting, windows, decks, gutters, roofing in Marietta e Região & North Atlanta." },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Siding Depot — James Hardie Elite Preferred Contractor in Marietta e Região GA" },
      { name: "twitter:description", content: "Georgia's trusted James Hardie Elite Preferred contractor. Siding, painting, windows, decks, gutters, roofing in Marietta e Região & North Atlanta." },
