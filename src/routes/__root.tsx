...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Georgia's trusted James Hardie Elite Preferred contractor. Siding, painting, windows, decks, gutters, roofing in Marietta, Alpharetta, Milton, Marietta e região & North Atlanta." },
      ...
      { property: "og:description", content: "Georgia's trusted James Hardie Elite Preferred contractor. Siding, painting, windows, decks, gutters, roofing in Marietta, Alpharetta, Milton, Marietta e região & North Atlanta." },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Siding Depot — James Hardie Elite Preferred Contractor in North Atlanta GA" },
      { name: "twitter:description", content: "Georgia's trusted James Hardie Elite Preferred contractor. Siding, painting, windows, decks, gutters, roofing in Marietta, Alpharetta, Milton, Marietta e região & North Atlanta." },
