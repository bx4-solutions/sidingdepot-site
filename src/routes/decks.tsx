...
const FAQS = [
  ...
  {
    q: "Do I need a permit to build a deck in Cobb or Cherokee County?",
    a: "Yes. Any deck over 30 inches above grade requires a building permit in Cobb, Cherokee, and Fulton counties. The process includes structural plan review and 2–3 inspections. Permit fees range $150–$600 depending on project value. We manage the full permit process — you never deal directly with the county.",
  },
  {
    q: "What decking material is best for Georgia's climate?",
  ...
  },
  {
    ...
    a: "Consistently yes. A well-built composite deck returns 65–75% of its cost at resale in the Atlanta metro according to Remodeling Magazine's Cost vs. Value Report. In high-demand areas like Milton, Alpharetta, and Roswell, outdoor living space is a meaningful competitive advantage.",
  },
  {
  ...
  },
  {
    ...
    a: "Trex is a composite decking brand made from 95% recycled material. Trex Transcend carries a 25-year fade and stain warranty. It's the most installed composite brand in North America — not because of marketing, but because it performs. We're a certified Trex Pro installer.",
  },
  {
    q: "Is financing available for a deck project?",
    a: "Yes. Through our GreenSky® partnership you can apply for 0% APR in 60 seconds with a soft credit check. Approval decisions are typically instant.",
  },
] as const;
...
const CONFIG: ServicePageConfig = {
  ...
  optionsSubheadline:
    "Every deck system we build is specified for Georgia's heat, humidity, and heavy rain season. Click to explore each option.",
  options: [
    {
      id: "composite",
      title: "Composite Decking",
      subtitle: "25-yr warranty · Zero maintenance",
      image: "/projects/project-1.webp",
      description:
        "Trex Transcend and TimberTech AZEK — no staining, no sealing, no splinters. Fade and stain warranty backed by the manufacturer for 25 years, certified by us as a Trex Pro installer.",
    },
    {
      id: "pressure-treated",
      title: "Pressure-Treated Wood",
      subtitle: "Budget-friendly · Classic look",
      image: "/projects/project-4.webp",
      description:
        "Southern Yellow Pine pressure-treated lumber — the most cost-effective structural decking option. Correct hardware is critical in Georgia's humidity. We don't cut corners on the details others skip.",
    },
    {
      id: "multilevel",
      title: "Multi-Level & Custom Design",
      subtitle: "Elevated · Architectural",
      image: "/projects/project-3.webp",
      description:
        "Multi-tier, L-shaped, and wraparound designs that match your home's footprint and your family's outdoor lifestyle. Every custom layout begins with site-specific engineered plans.",
    },
    {
      id: "screened",
      title: "Screened Porches",
      subtitle: "Year-round comfort · Bug-free",
  ...
  processSubheadline:
    "Deck projects involve permits, structural engineering, and material lead times. We manage every step so you don't have to.",
  steps: [
    {
      num: "01",
    ...
    {
      num: "02",
      title: "Site & Structural Evaluation",
      desc: "We assess ledger attachment points, footing depth, drainage, and HOA setback requirements specific to your lot — before a single board is ordered.",
    },
    {
      num: "03",
      title: "Permit-Ready Design & Proposal",
      desc: "You receive stamped framing plans, footing specs, and a detailed written estimate with material, labor, and permit costs itemized. The price in the proposal is the price you pay.",
    },
    {
      num: "04",
    ...
    {
      num: "05",
      title: "Final Walkthrough & Warranty Transfer",
      desc: "We walk the finished deck with you, confirm clean-up, and transfer your Trex or TimberTech material warranty in writing. Your outdoor space is ready to use the day we leave.",
    },
  ],
  ...
  authorityBody1:
    "Trex Pro certification isn't a sticker — it's a qualification that unlocks the full 25-year warranty on Trex Transcend. Non-certified installers can sell you the same boards, but their installation voids the manufacturer warranty the moment something goes wrong.",
  authorityBody2:
    "As a certified Trex Pro installer, every Siding Depot composite deck qualifies for the full material warranty — and every install follows Trex's engineering specifications for fastening, spacing, and ventilation. That distinction is invisible at installation and critical five years later.",
  authorityRows: [
