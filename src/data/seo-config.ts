...
export const SERVICE_METADATA_AB: Record<string, ServiceSeo> = {
  siding: {
    A: {
      ...
      metaDesc: "Top 2% Elite Preferred James Hardie installer for Marietta & North Atlanta. 50-year fiber cement durability. Free 24h quote — call Siding Depot.",
    },
    B: {
      ...
      metaDesc: "James Hardie fiber cement siding engineered for Georgia humidity, storms & UV. HZ10-rated install in North Atlanta. Get a free written estimate.",
    },
    C: {
  ...
  painting: {
    A: {
      h1: (c) => `Exterior Painting Services in ${c}, GA`,
      h2: "Sherwin-Williams Premium Systems with UV Protection",
      metaTitle: (c) => `Exterior Painting in ${c}, GA | Sherwin-Williams Premium`,
      metaDesc: "Sherwin-Williams Emerald & Duration exterior painting in North Atlanta. Multi-stage prep for long-lasting results. Free quote in 24h.",
    },
    B: {
      h1: (c) => `Stop Fading & Peeling — Exterior Painting in ${c}, GA`,
      h2: "UV-Shield Coatings Built for Georgia Heat",
      metaTitle: (c) => `Long-Lasting Exterior Paint ${c}, GA | UV-Shield`,
      metaDesc: "Premium UV-resistant paint systems engineered for Georgia heat & humidity. Resists mildew & fading. Free estimate from Siding Depot.",
    },
    C: {
  ...
  windows: {
    A: {
      ...
      metaDesc: "Energy Star certified Simonton & PGT windows installed in North Atlanta. Low-E double-pane built for Georgia summers. Free 24h quote.",
    },
    B: {
      ...
      metaDesc: "According to Energy Star, certified Low-E windows can meaningfully cut summer cooling costs in Atlanta. Free home assessment from Siding Depot.",
    },
    C: {
      h1: (c) => `Window Installation Experts in ${c}, GA`,
      h2: "Permits Handled · Manufacturer-Trained Crews",
      metaTitle: (c) => `Window Installers ${c}, GA | Cobb · Cherokee · Fulton`,
      metaDesc: "We handle Cobb, Cherokee & Fulton permits and install Simonton/PGT windows by manufacturer-trained crews. Free written quote in 24h.",
    },
  },
  doors: {
    A: {
      ...
      metaDesc: "Custom Therma-Tru & ProVia entry and patio doors installed in North Atlanta. Energy Star options. Multi-point security. Free 24h quote.",
    },
    B: {
    ...
    C: {
      ...
      metaDesc: "Custom entry & patio door replacement in North Atlanta. Authorized dealer. Precision install. Get a free written quote in 24 hours.",
    },
  },
  gutters: {
    A: {
    ...
    C: {
      ...
      metaDesc: "Most homes installed in 4–8 hours. Hidden-hanger seamless aluminum gutters. Licensed & insured in North Atlanta. Free quote.",
    },
  },
  deck: {
    A: {
      ...
      metaDesc: "Trex Pro & TimberTech composite decks built in North Atlanta. Permit-ready engineered plans. Free estimate in 24h.",
    },
    B: {
    ...
    C: {
      ...
      metaDesc: "We handle Cobb, Cherokee & Fulton permits and deliver stamped engineered plans on every deck. Free quote in 24h.",
    },
  },
  roofing: {
    A: {
      h1: (c) => `GAF Certified Roofing in ${c}, GA`,
      h2: "GAF Factory Certified Replacement & Repair",
      metaTitle: (c) => `Roofing in ${c}, GA | GAF Factory Certified`,
      metaDesc: "GAF Factory Certified roof replacement in North Atlanta. Golden Pledge® warranties available. Free 24h quote from Siding Depot.",
    },
    B: {
      ...
      metaDesc: "Hail & wind storm damage specialists. Free inspection and full insurance claim documentation in Cobb, Cherokee & Fulton. Call today.",
    },
    C: {
