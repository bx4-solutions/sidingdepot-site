...
export const SERVICE_METADATA_AB: Record<string, ServiceSeo> = {
  ...
  windows: {
    A: {
      ...
      metaDesc:
        "Energy Star certified Simonton & PGT windows installed in Greater Marietta. Low-E double-pane built for Georgia summers. Free 24h quote.",
    },
    B: {
      ...
      metaDesc:
        "According to Energy Star, certified Low-E windows can meaningfully cut summer cooling costs in Greater Marietta. Free home assessment from Siding Depot.",
    },
    C: {
      ...
      metaDesc:
        "We handle Greater Marietta permits and install Simonton/PGT windows by manufacturer-trained crews. Free written quote in 24h.",
    },
  },
  doors: {
    A: {
      ...
      metaDesc:
        "Custom Therma-Tru & ProVia entry and patio doors installed in Greater Marietta. Energy Star options. Multi-point security. Free 24h quote.",
    },
    B: {
    ...
    C: {
      ...
      metaDesc:
        "Custom entry & patio door replacement in Greater Marietta. Authorized dealer. Precision install. Get a free written quote in 24 hours.",
    },
  },
  gutters: {
    A: {
    ...
    C: {
      ...
      metaDesc:
        "Most homes installed in 4–8 hours. Hidden-hanger seamless aluminum gutters. Licensed & insured in Greater Marietta. Free quote.",
    },
  },
  decks: {
    A: {
      ...
      metaDesc:
        "Trex Pro & TimberTech composite decks built in Greater Marietta. Permit-ready engineered plans. Free estimate in 24h.",
    },
    B: {
    ...
    C: {
      ...
      metaDesc:
        "We handle Greater Marietta permits and deliver stamped engineered plans on every deck. Free quote in 24h.",
    },
  },
  "dumpster-rental": {
    A: {
      ...
      metaDesc:
        "10–30 yard roll-off dumpsters for renovations, cleanouts & construction in Greater Marietta. Next-day delivery, flat-rate pricing. Free quote.",
    },
    B: {
    ...
    C: {
      ...
      metaDesc:
        "Hassle-free roll-off dumpsters in Greater Marietta. Choose 10, 15, 20, or 30 yards. Next-day delivery available. Get a free quote today.",
    },
  },
  roofing: {
    A: {
      ...
      metaDesc:
        "GAF Factory Certified roof replacement in Greater Marietta. Golden Pledge® warranties available. Free 24h quote from Siding Depot.",
    },
    B: {
