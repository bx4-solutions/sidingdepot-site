...
export const BLOG_POSTS: BlogPost[] = [
  {
    slug: "is-siding-replacement-a-diy-job-georgia",
    title: "Is Siding Replacement a DIY Job? An Honest Answer for Georgia Homeowners",
    excerpt:
      "Siding looks simple enough to DIY — until a voided warranty and hidden moisture damage make it the most expensive shortcut you can take. Here's the honest math for Georgia homes.",
    ...
    heroImage: {
      ...
      alt: "Siding Depot crew installing James Hardie fiber cement siding on a Georgia home",
      caption:
        "A professional crew installing fiber cement siding — the safe alternative to a DIY re-side.",
    },
    sections: [
      {
        h2: "The short answer",
        content:
          'You have seen the videos: siding looks like nailing boards to a wall, and the internet is full of weekend warriors who swear it is easy. So it is a fair question — and this guide gives an honest answer, not a reflexive "always hire a pro for everything."\n\nHere it is straight. For one or two loose boards, maybe. For a full re-side of your house, no. The moisture risk, the weight of fiber cement, and above all the voided 30-year James Hardie warranty make a do-it-yourself re-side more expensive than hiring a crew. Most of the cost of a mistake does not show up on installation day — it shows up eighteen months later, inside the wall. Below is the why, in numbers.',
      },
      {
        h2: "5 reasons a full siding replacement isn't a weekend project",
        content:
          "A full siding replacement is a building-envelope project, not a cosmetic one. Here are the five reasons it belongs with a professional crew.",
        subsections: [
          {
            h3: "1. The James Hardie warranty depends on certified installation",
            content:
              "The 30-year limited warranty is not automatic — it requires installation within spec: correct expansion gaps, the right fasteners, and paint sealing every cut edge. Install it yourself and the warranty is voided. You lose the single biggest advantage of the premium product you paid for. That is why homeowners who want the coverage hire a [James Hardie Elite Contractor](/james-hardie) instead.",
          },
          {
            h3: "2. Fiber cement is heavy and cutting it releases silica dust",
            content:
              "A Hardie board weighs roughly 2.3 times a comparable vinyl plank. Cutting it without the right equipment releases silica dust, a serious respiratory hazard regulated by OSHA. This is genuinely a two-to-three-person job with the correct saw and dust control — not a solo afternoon with a circular saw.",
          },
          {
            h3: "3. The water barrier is where DIY jobs fail",
            content:
              "What keeps your house dry is not the siding — it is the water-resistive barrier and flashing underneath. An overlap that is off by less than half an inch will not show on install day; it shows up months later as [hidden wood rot](/blog/rotten-wood-siding-replacement-georgia-homes) inside the wall. Fixing that costs far more than the original job.",
          },
          {
            h3: '4. The "savings" shrink fast',
            content:
              "Scaffold and saw rental, disposal of the old material, and redoing anything that goes on crooked all eat the labor discount. So does time: a trained crew does in one to two weeks what a homeowner can stretch across an entire summer.",
          },
          {
            h3: "5. Resale and inspection",
            content:
              "Buyers and home inspectors ask for the invoice and a transferable warranty. A DIY installation with no documentation drags down the very value the new siding was supposed to add.",
          },
        ],
      },
      {
        h2: "When DIY is actually fine",
        content:
          "To be fair — and honest — some exterior work is reasonable to do yourself: repainting existing siding, swapping a single loose piece of trim, routine cleaning. That kind of small cosmetic upkeep is not what we do, and we will tell you so. What we do is complete, warrantied [professional siding replacement](/siding) — the full re-side, not the patch.",
      },
      {
        h2: "The honest cost comparison (Georgia, 2026)",
        content:
          'Put the two paths side by side and the "savings" of doing it yourself look very different once you price in the risk you are absorbing.\n\nThe gap that matters is not the sticker price — it is the risk you keep. Want your exact, itemized number instead of a guess? We deliver it in 24 hours, and financing is available at [0% APR financing](/finance) up to $65,000.',
        table: {
          headers: ["Path", "What you pay for", "What you carry"],
          rows: [
            [
              "DIY re-side",
              "Material plus tool and scaffold rental",
              "Voided warranty, moisture risk, and your own labor and time",
            ],
            [
              "Certified pro",
              "One fixed, itemized price",
              "A 30-year warranty, insurance, and a documented, transferable job",
            ],
          ],
        },
      },
      {
        h2: "Skip the risk — get a fixed quote",
        content:
          "You do not have to choose between overpaying and gambling your warranty. Get a fixed, itemized siding quote in 24 hours from a [James Hardie Elite Contractor](/james-hardie), and decide with real numbers in front of you. \n Get my free quote Call (678) 400-2012",
      },
    ],
    faq: [
      {
        q: "Can you install James Hardie siding yourself?",
        a: "Technically yes, but doing so voids the 30-year warranty, which is only valid with certified, to-spec installation.",
      },
      {
        q: "How much can I save doing siding myself?",
        a: "Less than it looks. The warranty risk and the cost of moisture damage usually outweigh the labor you save.",
      },
      {
        q: "What's the biggest DIY siding mistake?",
        a: "Getting the water barrier and flashing wrong. The damage doesn't show up right away — it appears months later as wood rot behind the wall.",
      },
      {
        q: "Is fiber cement harder to install than vinyl?",
        a: "Yes. It is heavier, cutting it releases silica dust, and its installation spec is stricter than vinyl's.",
      },
      {
        q: "Do you offer financing so I don't have to DIY?",
        a: "Yes — up to $65,000 at 0% APR for 12 months, so cost isn't a reason to risk a DIY re-side.",
      },
    ],
    cta: {
      city: "Georgia",
    ...
    metaTitle: "Is Siding Replacement a DIY Job? (Georgia)",
    metaDescription:
      "Thinking of installing siding yourself in Georgia? The honest math on DIY vs. hiring a pro: voided warranty, moisture damage and real costs. Free quote.",
    internalLinks: ["rotten-wood-siding-replacement-georgia-homes"],
  },
  {
    ...
    metaTitle: "James Hardie Siding in Marietta, GA: Buyer's Guide",
    metaDescription:
      "A practical guide to planning James Hardie siding in Marietta, GA: Georgia climate, scope, contractor questions and a written quote.",
    internalLinks: [],
  },
  {
    ...
    excerpt:
      "Real Marietta price ranges — and the prep and coating decisions that decide whether your paint lasts five years or fifteen.",
    ...
    metaTitle: "Exterior Painting Cost in Marietta, GA (2026)",
    metaDescription:
      "How much does exterior painting cost in Marietta, GA in 2026? Real price ranges by home size, what drives the quote, and how to get an itemized estimate fast.",
    internalLinks: [],
  },
  {
    ...
    excerpt:
      "Both are quality products, and their prices are close in 2026. The deciding factor for a North Atlanta home is how each one lives with heat, humidity and moisture over decades.",
    ...
    sections: [
      {
        h2: "James Hardie vs. LP SmartSide: what they actually are",
        content:
        ...
        table: {
          headers: ["Factor", "James Hardie (fiber cement)", "LP SmartSide (engineered wood)"],
          rows: [
            [
              "Core material",
    ...
    metaTitle: "James Hardie vs. LP SmartSide in Georgia",
    metaDescription:
      "James Hardie vs. LP SmartSide in Georgia's climate — durability, moisture, cost and resale compared so you pick the siding that lasts. Free itemized quote.",
    internalLinks: ["james-hardie-siding-marietta-ga"],
  },
  {
    ...
    sections: [
      ...
      },
      {
        h2: "Sources & Review Notes",
        content:
          "• [James Hardie — The best time of year for siding replacement](https://www.jameshardie.com/blog/siding-replacement/best-time-of-year-siding-replacement/) (accessed July 14, 2026)\n• Seasonal guidance is general; confirm current scheduling and lead times with Siding Depot operations before publication.",
      },
    ],
    faq: [
      {
    ...
    metaTitle: "Best Time to Replace Siding in Georgia",
    metaDescription:
      "When is the best time to replace siding in Georgia? How weather, scheduling and pricing line up — and why booking before fall saves money. Free estimate.",
    internalLinks: [],
  },
  {
    slug: "james-hardie-siding-cost-marietta-ga-2026",
    title:
      "How Much Does James Hardie Siding Cost in Marietta, GA? A 2026 Planning Guide for Homeowners",
    excerpt:
      "The purpose of this guide is not to promise a one-size-fits-all price. It is to help a Marietta homeowner understand what belongs in a professional siding estimate — and what to ask before choosing a contractor.",
    category: "Cost Guides",
    readTime: 8,
    publishDate: "2026-07-14",
    featured: true,
    ...
    heroImage: {
      ...
      caption:
        "Siding Depot crews installing fiber-cement siding on a two-story Marietta-style home. Height, window trim, brick transitions, and access all influence a project scope.",
    },
    sections: [
      {
        h2: "The Short Answer: What Should a Marietta Homeowner Budget?",
        content:
          "For a full siding replacement, begin with a project budget — not a single headline price. A simple one-story wall with easy access can price very differently from a two-story East Cobb home with brick transitions, dormers, several window packages, and damaged trim behind the old cladding.\n\nAs a planning range, professionally installed fiber-cement siding commonly falls in the low-to-mid teens per square foot of siding area before unusual repairs. That is not a quote. A responsible number comes only after the exterior is measured, the existing materials are identified, and the contractor explains what happens if hidden damage is found.",
        pullQuote:
          "The question that protects a homeowner is not, 'What is your price per square foot?' It is, 'What exactly is included around my windows, trim, weather barrier, tear-off, and repairs?'",
        table: {
          headers: ["Project profile", "Scope to discuss", "Why cost changes"],
          rows: [
            [
              "Single-story ranch",
      ...
      },
      {
        ...
        content:
          "A professional estimate separates the work into understandable parts. This lets a homeowner compare scope before comparing total price.",
        subsections: [
          {
            h3: "1. Removal and disposal",
            content:
              "The scope should say whether the old siding is removed, where debris goes, and when the wall is inspected. Covering a failing substrate can create a more expensive problem later.",
          },
          {
            h3: "2. The wall system behind the siding",
            content:
              "House wrap, flashing, fasteners, caulk, and transitions around openings are not minor accessories. They manage water in Marietta's humid, rain-heavy climate.",
          },
          {
            h3: "3. Siding, trim, and finish choices",
            content:
              "Lap siding, vertical panels, shingles, trim width, soffit work, and factory-finished versus field-painted products affect both material and labor.",
          },
          {
            h3: "4. Access, protection, and cleanup",
            content:
              "Two-story work, landscaping protection, driveway access, scaffolding, and daily cleanup are real labor items on established Marietta lots with mature trees and tight side yards.",
          },
        ],
      },
      {
        ...
        content:
          "The siding itself is only one layer of the exterior. The final price can change when a crew finds a condition that could affect the performance of the new wall system. A good contractor does not hide that possibility; they explain it before work starts and document it if it appears.",
        image: {
          ...
          caption:
            "Window openings are where an estimate becomes a wall-system plan: weather barrier, flashing, trim, repair scope, and labor all need to be visible in the written proposal.",
        },
        subsections: [
          {
            h3: "Hidden rot and damaged sheathing",
            content:
              "Soft wood at a window, a loose panel, or staining beneath a roofline can signal water intrusion. It does not automatically mean a full rebuild, but it does deserve a documented inspection and repair recommendation.",
          },
          {
            h3: "Height and architectural detail",
            content:
              "Gables, second stories, brick transitions, decorative bands, and multi-level rooflines require more measurements, cuts, staging, and safety work. These are familiar features on many East Cobb homes and should be visible in the estimate, not treated as a surprise.",
          },
          {
            h3: "Permit and HOA review",
            content:
              "Requirements vary by property and jurisdiction. If a permit, HOA package, color approval, or engineering review applies, the proposal should say who handles it, what is included, and what is excluded.",
          },
        ],
      },
      {
        ...
        content: "",
        table: {
          headers: ["Question to ask", "A useful answer includes"],
          rows: [
            ["What is removed?", "Old cladding, disposal, and an inspection sequence."],
            [
            ...
            ["Who performs the work?", "A named crew process and supervision plan."],
            [
        ...
        subsections: [
          {
            ...
            content:
              "Lap siding is the familiar horizontal profile many homeowners picture first. It can be a straightforward choice on broad wall areas, but the installation still depends on layout, cuts, trim, fasteners, wall preparation, and how the crew handles doors, windows, and roof-to-wall details. The board itself is only one line in a complete exterior scope.",
          },
          {
            h3: "HardiePanel and vertical design areas",
            content:
              "Vertical panels can create a board-and-batten look on gables, entries, or whole elevations. They also change the layout work: battens, reveals, transitions, and trim details must be planned so the façade looks intentional from the street. A lower material line item does not always mean a lower installed scope when more finishing work is involved.",
          },
          {
            h3: "Trim, soffit, and color decisions",
            content:
              "Trim width, corner boards, fascia, soffit repairs, and the finish system shape both the final look and the labor plan. A proposal should identify whether those components are repaired, replaced, wrapped, painted, or excluded. That level of detail makes two bids comparable and avoids treating the visible siding boards as the entire project.",
          },
        ],
      },
      {
    ...
    metaTitle: "James Hardie Siding Cost in Marietta, GA (2026)",
    metaDescription:
      "See what James Hardie siding costs in Marietta, GA for 2026 — real price ranges, what changes your quote, and how to get an itemized estimate in 24 hours.",
    internalLinks: ["james-hardie-siding-marietta-ga"],
  },
  {
    ...
    excerpt:
      "Vinyl wins on upfront price. Fiber cement wins on longevity, fire and resale. Here is how the two really compare on a North Atlanta home — without the sales spin.",
    category: "Comparisons",
    readTime: 9,
    publishDate: "2026-07-14",
    featured: false,
    ...
    sections: [
      {
        h2: "James Hardie vs. vinyl siding: the head-to-head",
        content:
        ...
        table: {
          headers: ["Factor", "James Hardie (fiber cement)", "Vinyl"],
          rows: [
            ["Installed cost", "~$8–$14 / sq ft", "~$2–$5 / sq ft"],
            ["Lifespan", "30–50+ years", "20–40 years"],
            ["Fire", "Non-combustible (Class A)", "Combustible; can melt"],
            [
              "Moisture & pests",
              "Resists rot; not a pest food source",
              "Resists moisture; can trap it if damaged",
            ],
            ["Heat & warping", "Dimensionally stable", "Can warp or fade in intense sun"],
            [
              "Maintenance",
              "Periodic repaint (or long-lasting ColorPlus)",
              "Rinse with a hose; color molded in",
            ],
            ["Resale signal", "Premium", "Often reads builder-grade"],
          ],
        },
      },
      {
    ...
    metaTitle: "James Hardie vs. Vinyl Siding in Georgia: Honest Verdict",
    metaDescription:
      "James Hardie vs. vinyl siding in Georgia: real cost, durability in heat and storms, and the honest verdict on which is worth it. Itemized quote in 24 hours.",
    internalLinks: ["james-hardie-siding-cost-marietta-ga-2026"],
  },
  {
    slug: "6-signs-time-replace-siding-georgia-home",
    title: "8 signs it’s time to replace your siding in Georgia",
    excerpt:
      "Some siding problems are cosmetic. Others are your home telling you water is already getting in. Here is how to tell the difference before a small issue becomes a structural one.",
    ...
    metaTitle: "8 Signs It's Time to Replace Your Siding (Georgia)",
    metaDescription:
      "Eight clear signs it's time to replace your siding in Georgia — warping, rot, rising energy bills and more — plus what a full re-side costs. Free estimate.",
    internalLinks: [
  ...
  },
  {
    ...
    excerpt:
      "What looks like a small soft spot is often the tip of a much bigger problem hiding behind the wall. Here is how to find it, price it, and stop it from coming back.",
    category: "Home Maintenance",
    readTime: 8,
    publishDate: "2026-07-14",
    featured: false,
    ...
    metaTitle: "Hidden Wood Rot in Georgia Homes: Catch It Early",
    metaDescription:
      "Hidden wood rot behind Georgia siding spreads fast. How to spot it early, what causes it, and when a full re-side is the fix. Free inspection & itemized quote.",
    internalLinks: ["james-hardie-siding-marietta-ga"],
  },
  {
    ...
    excerpt:
      "Few exterior projects return as much of their cost as new siding — and in Atlanta’s climate, the right material pays you back twice: at resale and every year you own the home.",
    category: "Cost Guides",
    readTime: 8,
    publishDate: "2026-07-14",
    featured: false,
    ...
    metaTitle: "Does New Siding Increase Home Value? Atlanta ROI 2026",
    metaDescription:
      "Siding ROI and resale value for Atlanta homes in 2026: what the numbers say and the returns you keep even if you never sell.",
    internalLinks: [
  ...
  },
  {
    ...
    excerpt:
      "Georgia’s storm season damages more siding than most homeowners realize. Handle the claim in the right order and you protect both your home and your payout.",
    category: "Insurance",
    readTime: 9,
    publishDate: "2026-07-14",
    featured: false,
    ...
    metaTitle: "Hail-Damaged Siding in Georgia: Insurance Claim Guide",
    metaDescription:
      "A step-by-step Georgia guide to filing a hail-damage siding insurance claim: inspect first, document, deductibles, and what to do if denied.",
    internalLinks: ["james-hardie-siding-marietta-ga"],
  },
  {
    ...
    excerpt:
      "From the first call to the final walkthrough, here is a realistic schedule for a North Atlanta siding project — and the factors that can speed it up or slow it down.",
    category: "Planning",
    readTime: 7,
    publishDate: "2026-07-14",
    featured: false,
    ...
    metaTitle: "How Long Does Siding Installation Take? (Georgia)",
    metaDescription:
      "A realistic North Atlanta siding installation timeline: 4-7 days of install, the full phase-by-phase schedule, and what speeds it up or slows it down.",
    internalLinks: ["best-time-to-replace-siding-georgia"],
  },
  {
    slug: "hardie-siding-colors-2026-north-atlanta-homes",
    title: "The best James Hardie siding colors for 2026 (North Atlanta homes)",
    excerpt:
      "From versatile grays to warm greiges and deep, moody accents — here are the colors defining North Atlanta exteriors this year, and how to choose one you will still love in a decade.",
    category: "Design",
    readTime: 8,
    publishDate: "2026-07-14",
    featured: false,
    ...
    sections: [
      ...
      },
      {
        ...
        pullQuote:
          "The best siding color is not the boldest one on the sample board. It is the one that still looks right on your street in ten years.",
      },
      {
    ...
    metaDescription:
      "The most popular James Hardie siding colors for 2026, the ColorPlus vs paint decision, and how to choose a color for a North Atlanta home.",
    internalLinks: ["exterior-home-design-trends-north-atlanta-2026"],
  },
  {
    ...
    metaTitle: "Board & Batten Siding in North Atlanta: Cost & Styles",
    metaDescription:
      "James Hardie board and batten siding for North Atlanta: how the system works, what it costs, where it looks best and how to get the proportions right.",
    internalLinks: ["james-hardie-siding-cost-marietta-ga-2026"],
  },
  {
    ...
    excerpt:
      "Warmth is winning over starkness this year. Here are the color, material and profile trends shaping North Atlanta exteriors — and how to use them without dating your home.",
    category: "Design",
    readTime: 8,
    publishDate: "2026-07-14",
    featured: false,
    ...
    sections: [
      {
        ...
        content:
          "Exterior trends move more slowly than interior ones — a facade is expensive to redo, so the smart directions are the ones with staying power. For 2026, the overall story is a move away from the cold, stark, all-gray minimalism of the past several years and toward something warmer, more layered and more textured. Here is what is emerging, what is fading, and how to bring the good parts home to a North Atlanta house without chasing a fad you will regret.\n\n[Planning a refresh? Get a written quote and design guidance →](/contact)",
        table: {
          headers: ["Fading in 2026", "Emerging in 2026"],
          rows: [
            ["Cool, stark grays as the default", "Warm, layered neutrals (“quiet luxury”)"],
            ["Flat, single-material facades", "Mixed materials — fiber cement with stone or cedar"],
            ["Narrow, busy siding profiles", "Wider lap with smooth, minimalist finishes"],
            ["All-neutral, no-contrast schemes", "Deep, moody accents for high contrast"],
          ],
        },
      },
      {
    ...
    metaDescription:
      "The 2026 exterior design trends shaping North Atlanta homes: warm neutrals, moody accents, mixed materials and wider siding profiles.",
    internalLinks: [
