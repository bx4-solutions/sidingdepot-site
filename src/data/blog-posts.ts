...
export const BLOG_POSTS: BlogPost[] = [
    ...
    faq: [
      {
        ...
        a: "Expect $19,000–$28,000 for James Hardie installed, including tear-off and house wrap.",
      },
      {
        q: "How long does James Hardie siding last in Georgia?",
        a: "50+ years when properly installed by a certified HZ10 contractor.",
      },
      {
        q: "Is James Hardie worth it over vinyl siding in North Atlanta?",
        a: "Yes. At a $400k+ home value, vinyl signals builder-grade. Hardie adds resale value and lasts twice as long.",
      },
      {
        q: "How do I know if I need full replacement or just repair?",
        a: "If more than 20% of panels are damaged, full replacement is more cost-effective. We'll tell you honestly.",
      },
    ],
    cta: { city: "Marietta", service: "Siding" },
    metaTitle: "James Hardie Siding Cost Marietta GA 2026 | Price Guide",
    metaDescription:
      "How much does James Hardie siding cost in Marietta, GA in 2026? Real prices from $8–$14/sqft installed. Full breakdown by home size and style.",
    internalLinks: [
      "6-signs-time-replace-siding-georgia-home",
      "james-hardie-vs-vinyl-siding-georgia-climate",
    ],
  },
  {
    ...
    faq: [
      {
        ...
        a: "If less than 20% of your siding is damaged, repair may be an option. However, for older homes, full replacement is often more cost-effective and ensures a uniform appearance.",
      },
      {
        q: "How do I know if I have rot behind my siding?",
        a: 'Look for "soft spots" in the wall or areas where the siding feels spongy. A professional inspection with a moisture meter is the most reliable method.',
      },
      {
        q: "Does insurance cover siding replacement for hail damage?",
        a: "Yes, if the damage was caused by a documented storm event. We work with adjusters to ensure all damage is properly accounted for.",
      },
      {
        q: "What is the best siding for the Georgia climate?",
        a: "James Hardie fiber cement is widely considered the best choice because it resists rot, fire, and the intense Georgia humidity.",
      },
    ],
    cta: { city: "Alpharetta", service: "Siding" },
    metaTitle: "6 Signs It's Time to Replace Siding in Georgia | Siding Depot",
    metaDescription:
      "Is your siding failing? Look for these 6 critical signs of damage in Georgia homes, from warping to hidden rot. Expert advice from Siding Depot.",
    internalLinks: [
    ...
    faq: [
      {
        ...
        a: "Yes, if you plan to stay in your home for more than 5 years or care about maximizing resale value.",
      },
      {
        q: "Does vinyl siding protect against woodpeckers?",
        a: "No, woodpeckers and other pests can easily penetrate vinyl. James Hardie is bird and insect resistant.",
      },
      {
        q: "Which material is better for Georgia humidity?",
        a: "Fiber cement is superior because it does not support mold growth and is not affected by moisture like wood or vinyl.",
      },
      {
        q: "How does the resale value compare?",
        a: "Homes with James Hardie siding typically sell faster and for a higher price point in the North Atlanta market.",
      },
    ],
    cta: { city: "Johns Creek", service: "Siding" },
    metaTitle: "James Hardie vs Vinyl Siding Georgia 2026 | Siding Depot",
    metaDescription:
      "Honest comparison of James Hardie vs Vinyl for Georgia homes. Learn why fiber cement is the superior choice for the Atlanta climate.",
    internalLinks: [
      "james-hardie-siding-cost-marietta-ga-2026",
      "6-signs-time-replace-siding-georgia-home",
    ],
  },
  {
    ...
    excerpt:
      "The 'Modern Farmhouse' aesthetic is taking over Milton and Alpharetta. Learn how to achieve this look with James Hardie.",
    ...
    sections: [
      {
        ...
        image: {
          ...
          caption:
            "The Modern Farmhouse aesthetic remains a top choice for North Atlanta homeowners in 2026.",
        },
      },
      {
        ...
        pullQuote:
          "Board and Batten isn't just a siding choice—it's a precision trim project. The quality of the installation shows in every single vertical line.",
      },
      {
        ...
        image: {
          ...
          caption:
            "Premium siding helps maintain community standards and individual property values.",
        },
      },
      {
    ...
    faq: [
      {
        q: "Can I mix Board and Batten with Lap siding?",
        a: "Yes, this is a popular trend! Using Board and Batten in gables while keeping lap siding on the main body creates beautiful architectural interest.",
      },
      {
        q: "What is the most popular color for Board and Batten in 2026?",
        a: "Arctic White and Iron Gray are currently the top choices for Marietta and Milton homeowners.",
      },
    ],
    cta: { city: "Milton", service: "Siding" },
    metaTitle: "Board and Batten Siding Guide North Atlanta 2026",
    metaDescription:
      "Complete guide to Board and Batten siding in North Atlanta. Learn about costs, style trends, and how to get HOA approval.",
    internalLinks: [
      "james-hardie-siding-cost-marietta-ga-2026",
  ...
  },
  {
    ...
    excerpt:
      "Discover why siding replacement remains the #1 home improvement for return on investment in the Atlanta metro area.",
    category: "Home Value",
    readTime: 8,
    ...
    heroImage: {
      ...
      caption:
        "First impressions are everything. New siding can increase your home's appraised value overnight.",
    },
    sections: [
      {
        ...
        image: {
          ...
          caption:
            "Investing in high-quality exterior materials consistently yields a better return than many interior renovations.",
        },
      },
      {
        ...
        image: {
          ...
          caption:
            "Curb appeal is a primary driver for property valuation in the Marietta and Alpharetta markets.",
        },
      },
    ],
    faq: [
      {
        q: "Does new siding help sell a house faster?",
        a: "Absolutely. Homes with new James Hardie siding spend an average of 15 days less on the market in Cobb and Fulton counties.",
      },
    ],
    cta: { city: "Marietta", service: "Siding" },
    metaTitle: "Siding ROI Atlanta 2026 | Cost vs Value | Siding Depot",
    metaDescription:
      "Is new siding worth the investment? See the 2026 ROI data for siding replacement in the Atlanta metro area.",
    internalLinks: [
      "james-hardie-siding-cost-marietta-ga-2026",
      "hardie-siding-colors-2026-north-atlanta-homes",
    ],
  },
  {
    ...
    excerpt:
      "Don't settle for a patch job. [See our Marietta siding replacement guide](/lp/siding-canton) to get your insurance to cover a full replacement.",
    ...
    sections: [
      {
        ...
        image: {
          ...
          caption:
            "Georgia storm seasons can bring sudden and severe weather that impacts home exteriors.",
        },
      },
      {
        ...
        pullQuote:
          "Insurance adjusters are trained to minimize claims. We are trained to document every single point of impact to ensure your home is fully protected.",
      },
      {
        ...
        image: {
          ...
          caption:
            "Ensuring a consistent look across the entire home is essential for maintaining market value after a storm repair.",
        },
      },
      {
    ...
    faq: [
      {
        ...
        a: "Most Georgia policies require you to file within 12 months of the storm event.",
      },
      {
        q: "Will filing a claim raise my rates?",
        a: 'In Georgia, insurance companies generally cannot raise your individual rates for "Acts of God" like hail storms.',
      },
    ],
    cta: { city: "Marietta", service: "Siding" },
    metaTitle: "Siding Hail Damage Claims Georgia 2026 | Siding Depot",
    metaDescription:
      "Step-by-step guide to filing an insurance claim for siding hail damage in Georgia. Learn your rights and maximize your coverage.",
    internalLinks: [
      "6-signs-time-replace-siding-georgia-home",
  ...
  },
  {
    ...
    excerpt:
      "Discover the most popular color palettes for homes in Marietta, Alpharetta, and Milton this year.",
    ...
    heroImage: {
      ...
      caption:
        "Dark, moody colors like Iron Gray are dominating the design landscape in North Atlanta this year.",
    },
    sections: [
      {
        ...
        image: {
          ...
          caption:
            "High-contrast color palettes create a bold and modern aesthetic for contemporary Georgia homes.",
        },
      },
      {
        ...
        image: {
          ...
          caption:
            "Arctic White is a versatile and timeless choice that continues to be a favorite in Milton and Alpharetta.",
        },
      },
    ],
    faq: [
      {
        q: "Do dark colors fade faster in Georgia?",
        a: "With James Hardie ColorPlus technology, the color is baked on in a controlled environment, making it significantly more resistant to UV fading than traditional paint.",
      },
    ],
    cta: { city: "Alpharetta", service: "Siding" },
    metaTitle: "James Hardie Siding Colors 2026 North Atlanta",
    metaDescription:
      "See the most popular siding color trends for Georgia homes in 2026. From Iron Gray to Arctic White, find your perfect palette.",
    internalLinks: [
  ...
  },
  {
    ...
    excerpt:
      "A day-by-day guide to your siding replacement project, from permit approval to final walk-through.",
    ...
    sections: [
      {
        ...
        image: {
          ...
          caption:
            "Thorough planning is the foundation of a successful siding replacement project.",
        },
      },
      {
        ...
        image: {
          ...
          caption:
            "The tear-off phase reveals the true condition of your home's structural elements.",
        },
      },
      {
    ...
    faq: [
      {
        ...
        a: "No, most of the work is exterior. However, we do need access to an outdoor power outlet and water source.",
      },
    ],
    cta: { city: "Marietta", service: "Siding" },
    metaTitle: "Siding Installation Timeline Georgia 2026",
    metaDescription:
      "How long does it take to replace siding? See our realistic timeline for Georgia homeowners.",
    internalLinks: [
      "james-hardie-siding-cost-marietta-ga-2026",
      "rotten-wood-siding-replacement-georgia-homes",
    ],
  },
  {
    ...
    excerpt:
      "What happens when moisture gets behind your siding? Learn why Addressing rot is the most important part of a siding project.",
    category: "Home Maintenance",
    readTime: 11,
    ...
    heroImage: {
      ...
      caption:
        "Rot often hides in plain sight, slowly compromising your home's structural integrity.",
    },
    sections: [
      {
    ...
    faq: [
      {
        q: "How do I know if I have rot before the siding is removed?",
        a: 'Look for soft spots, "mushroom" growth, or a musty smell near exterior walls. However, some rot is only visible once the siding is off.',
      },
    ],
    cta: { city: "Woodstock", service: "Siding" },
    metaTitle: "Rotten Wood Behind Siding Georgia | Repair Guide",
    metaDescription:
      "Don't ignore hidden rot. Learn how Siding Depot identifies and repairs structural wood damage during siding replacement.",
    internalLinks: [
      "6-signs-time-replace-siding-georgia-home",
      "how-long-does-siding-installation-take-georgia",
    ],
  },
  {
    ...
    excerpt:
      "From mixed materials to moody palettes, see what's defining high-end curb appeal this year.",
    category: "Design & Color",
    readTime: 10,
    ...
    sections: [
      {
        ...
        image: {
          ...
          caption:
            "Mixed material exteriors are one of the fastest growing trends in the North Atlanta high-end market.",
        },
      },
      {
    ...
    faq: [
      {
        q: "Is the Modern Farmhouse trend over?",
        a: 'Not at all, but it is evolving into "Modern Traditional" which uses the same clean lines but with more diverse color palettes.',
      },
    ],
    cta: { city: "Alpharetta", service: "Siding" },
    metaTitle: "Exterior Design Trends North Atlanta 2026",
    metaDescription:
      "Get inspired for your home renovation. See the top exterior design and siding trends for 2026 in North Atlanta.",
    internalLinks: [
      "hardie-siding-colors-2026-north-atlanta-homes",
      "board-batten-siding-guide-north-atlanta-2026",
    ],
  },
  {
    ...
    excerpt:
      "Planning a siding replacement in the Atlanta area? Get the honest 2026 cost breakdown for fiber cement siding, compare options, and learn how to budget with our comprehensive cost guide.",
    category: "Cost Guides",
    readTime: 11,
    ...
    heroImage: {
      ...
      caption:
        "A classic Atlanta home featuring a full fiber cement siding replacement, boosting both protection and curb appeal.",
    },
    sections: [
      {
        ...
        table: {
          ...
          rows: [
            ...
            [
              ...
              "High",
              "20-30 Years",
              "Moderate (Risk of rot)",
              "High (Paint/Stain every 3-5 yrs)",
            ],
            ["Engineered Wood", "Moderate", "25-35 Years", "Good", "Moderate"],
          ],
        },
        pullQuote:
          "Choosing siding based solely on the lowest price is a mistake in Georgia. Our extreme summer humidity and heat will expose poor materials and installation within just a few seasons.",
      },
      {
    ...
    faq: [
      {
        q: "How much does it cost to reside a 2,500 sq ft house in Atlanta?",
        a: "For a 2,500 sq ft house (approx. 3,200 sq ft of wall area), a full fiber cement replacement typically runs between $27,000 and $45,000 depending on complexity.",
      },
      {
        q: "Is James Hardie siding worth the extra cost over vinyl?",
        a: "Yes. In the Atlanta climate, vinyl is prone to UV distortion and warping. James Hardie lasts twice as long, is fire-resistant, and maintains higher resale value.",
      },
      {
    ...
    metaDescription:
      "Planning a siding replacement in Atlanta? Get the honest 2026 cost breakdown for fiber cement siding, compare options, and learn how to budget.",
    internalLinks: [
      "james-hardie-siding-cost-marietta-ga-2026",
      "james-hardie-vs-vinyl-siding-georgia-climate",
      "6-signs-time-replace-siding-georgia-home",
      "siding-replacement-cost-vs-value-report-atlanta-2026",
    ],
  },
];
