    ...
    <div className="bg-white min-h-screen font-sans">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <nav className="flex items-center flex-wrap gap-2 text-[11px] font-bold uppercase tracking-widest text-sd-gray-text/60 mb-12" aria-label="Breadcrumb">
          <Link to="/" className="hover:text-sd-black transition-colors">Home</Link>
          <ChevronRight className="w-3 h-3" />
          <Link to="/blog" className="hover:text-sd-black transition-colors">Blog</Link>
          <ChevronRight className="w-3 h-3" />
        ...
        <div className="flex flex-col lg:flex-row gap-16">
          ...
          <aside className="lg:w-[35%]">
            <div className="sticky top-24 space-y-12">
              ...
              <div className="bg-sd-black p-10 rounded-[32px] shadow-2xl border border-white/5 relative overflow-hidden">
