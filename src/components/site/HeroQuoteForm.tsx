        ...
        <form onSubmit={handleSubmit} noValidate className={bare ? "grid gap-3" : "px-6 py-5 grid gap-3.5"}>
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="grid gap-1.5">
              <Label htmlFor="hero-service" className="text-xs font-semibold text-sd-black">
              ...
              {errors.service && (
                <p className="text-[11px] text-destructive">{errors.service}</p>
              )}
            </div>
          </div>

          <div className="grid gap-1.5">
            <Label htmlFor="hero-details" className="text-xs font-semibold text-sd-black">
              Tell us about your project (optional)
            </Label>
            <Textarea
              id="hero-details"
              placeholder="Describe your project, home size, timeline, or any questions..."
          ...
          <div className="flex items-start gap-2.5 mt-1">
            ...
            <div className="grid gap-1">
              <Label
                ...
                className="text-[10px] leading-snug font-normal text-sd-gray-text cursor-pointer"
              >
              ...
              {errors.consent && (
                <p className="text-[11px] text-destructive leading-none">{errors.consent}</p>
              )}
            </div>
          </div>
          ...
          <Button 
            ...
            size="lg" 
            disabled={submitting} 
            className="mt-2 w-full font-bold bg-sd-green text-sd-dark hover:bg-sd-green-hover shadow-lg"
          >
            {submitting ? (
              <>
          ...
          <p className="text-[9px] text-sd-gray-text text-center mt-1">
            🔒 Response within 24h · Your data is safe with us
          </p>
        </form>
      )}
    </div>
